...
public class PersistentAccountDAO implements AccountDAO {
    ...
    public List<String> getAccountNumbersList() {
        ...
        Cursor cursor = db.rawQuery("SELECT "+ DatabaseHelper.KEY_ACCOUNT_NO +" FROM " + DatabaseHelper.TABLE_ACCOUNTS, null);
    ...
    public List<Account> getAccountsList() {
        ...
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + DatabaseHelper.TABLE_ACCOUNTS, null);
    ...
    public Account getAccount(String accountNo) throws InvalidAccountException {
        ...
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + DatabaseHelper.TABLE_ACCOUNTS + " WHERE " + DatabaseHelper.KEY_ACCOUNT_NO +" = " + accountNo, null);
